...
v6 = Video.create!({id: 6, director_name: "Kenneth Branagh ", year: 2020, description: "Artemis Fowl, a young criminal prodigy, hunts down a secret society of fairies to find his missing father.", title: "Artemis Foul", rating:'PG'}),
